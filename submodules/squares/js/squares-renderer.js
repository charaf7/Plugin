var map = undefined;			// for config map global
var infoFromGoogle = undefined;	// for recup infoFromGoogle global
var marker = undefined;			// for marker google Global
var latLongGoogle = undefined;	// for LatLongGoogle Global
var infowindow = undefined;		// for window from Googlemap Golbal

var dataDropzone = undefined;	// for image global
var allquizz = undefined; 		// for image global
...
;(function($, window, document, undefined) {
	...
	$.squaresRendererRenderObject = function(settings, id) {
		spotId = id; // recupere le type du spot;
		// console.log(spotId);
	...
	Element.prototype.init = function(e) {
		...
		this.id = uniqid();
		if (registeredElements[this.settings.name].controls.general.hasOwnProperty('id')) {
          registeredElements[this.settings.name].controls.general.id.default = 'square-element-' + this.id;
        }
	...
	Element.prototype.render = function() {
		...
		html += registeredElements[this.settings.name].render(this.options, spotId);
		html += '</div>';
