...
;(function ($, window, document, undefined) {
    ...
    //var used to fil the form to add the image in the center area
    var firstImage = '';
    ...
    WCPEditor.prototype.init = function(options) {
        ...
        if (this.options.newButton) {
            ...
            html += '           <div class="wcp-editor-main-button-text">Nouveau</div>';
            html += '       </div>';
        }
        html += '       <div id="wcp-editor-button-save" class="wcp-editor-main-button">';
        html += '           <div class="wcp-editor-main-button-icon"><i class="fa fa-save" aria-hidden="true"></i></div>';
        html += '           <div class="wcp-editor-main-button-text">Sauvegarder</div>';
        html += '       </div>';
        html += '       <div id="wcp-editor-button-load" class="wcp-editor-main-button">';
        html += '           <div class="wcp-editor-main-button-icon"><i class="fa fa-sign-out-alt" aria-hidden="true"></i></div>';
        html += '           <div class="wcp-editor-main-button-text">Charger</div>';
        html += '       </div>';
        ...
        html += '           <div class="wcp-editor-main-button-text">Annuler</div>';
        html += '       </div>';
        html += '       <div id="wcp-editor-button-redo" class="wcp-editor-main-button">';
        html += '           <div class="wcp-editor-main-button-icon"><i class="fa fa-redo" aria-hidden="true"></i></div>';
        html += '           <div class="wcp-editor-main-button-text">Refaire</div>';
        html += '       </div>';
        ...
        // html += '           <div class="wcp-editor-main-button-text">Aperçu</div>';
        // html += '       </div>';
        ...
        //     html += '<div class="wcp-editor-main-tab-button" data-wcp-main-tab-button-name="'+ this.options.mainTabs[1].name +'">';
        //     html += '   <div class="wcp-editor-main-tab-button-icon"><i class="'+ this.options.mainTabs[1].icon +'" aria-hidden="true"></i></div>';
        //     html += '   <div class="wcp-editor-main-tab-button-text">'+ this.options.mainTabs[1].texte +'</div>';
        //     html += '</div>';
        // //}
        // //html += '</div>';
        ...
        //for (var i=0; i<this.options.mainTabs.length; i++) {
            html += '<div class="wcp-editor-main-tab-content" data-wcp-main-tab-content-name="'+ this.options.mainTabs[1].name +'">';
            html += '   <div class="wcp-editor-main-tab-content-title">'+ this.options.mainTabs[1].title +'</div>';
            html += '   <div class="wcp-editor-main-tab-content-inner-wrap">'+ $.wcpEditorGetContentForTabWithName(this.options.mainTabs[1].name) +'</div>';
            html += '</div>';
       // }
        html += '</div>';
        html += '<div class="CulturMoov_header"><img src="img/logo.png"><span id ="pluginInOrange">Plugin</span></div>'
        html += '</div>';
        ...
        // Preview mode  
        html += '       <div id="wcp-editor-button-preview" class="wcp-editor-main-button specialPreviewButton">';
        html += '           <div class="wcp-editor-main-button-icon"><i class="fa fa-eye" aria-hidden="true"></i></div>';
        html += '           <div class="wcp-editor-main-button-text">Aperçu</div>';
        html += '       </div>';
        // Extra main buttons
        ...
        for (var i=0; i<this.options.extraMainButtons.length; i++) {
            ...
            html += '       <div id="'+b.id+'" class="wcp-editor-extra-main-button" data-wcp-editor-extra-main-button-name="'+ b.name +'" '+ tooltip +'>';
            html += '           <div class="wcp-editor-extra-main-button-icon"><i class="'+ b.icon +'" aria-hidden="true"></i></div>';
            html += '           <div class="wcp-editor-extra-main-button-title" id="'+b.title+'">'+ b.title +'</div>';
            html += '       </div>';
        }
        html += '    </div>';
        
        // Add first image form
        html += '<div id="firstImage">';
        html += firstImage;
        html += '</div>';
        ...
        if (this.options.toolbarButtons[0].constructor == Array) {
            ...
            for (var i=0; i<this.options.toolbarButtons.length; i++) {
                html += '   <div id="wcp-editor-toolbar" class="wcp-editor-toolbar-grouped wcp-editor-toolbar-btn-select">';
        ...
        // Title
        html += '   <div id="wcp-editor-title-proj" class="" style=""></div>';
        
        //CHANGED TO SHOW JUST THE ICON SETTINGS
        html += '<div class="wcp-general-settings"  style="">'; 
          html += '<div id="wcp-editor-main-tab-contents">';
        //for (var i=0; i<this.options.mainTabs.length; i++) {
            html += '<div class="wcp-editor-main-tab-content" data-wcp-main-tab-content-name="'+ this.options.mainTabs[0].name +'">';
            html += '   <div class="wcp-editor-main-tab-content-title" id="specialCliquableSetting">'+ this.options.mainTabs[0].title +'</div>';
            html += '   <div class="wcp-editor-main-tab-content-inner-wrap">'+ $.wcpEditorGetContentForTabWithName(this.options.mainTabs[0].name) +'</div>';
            html += '</div>';
        //}
          html += '</div>';
        html += '</div>';
        ...
        // Infosplus
        html += '   <div id="wcp-editor-infosplus" class="" style=""></div>'
        // Footer
        html += '   <div id="wcp-editor-phrase-accroche" class="navbar-fixed-bottom" style=""></div>'
    ...
    WCPEditor.prototype.events = function () {
        ...
        // Main buttons events
        $(document).off('click', '#wcp-active-show-edition');
        $(document).on('click', '#wcp-active-show-edition', function() {
        ...
        $(document).on('click', '.wcp-editor-extra-main-button', function(e) {
            ...
            if(buttonName == 'tablet'){
                self.presentTabletResize();
                $('.fa-tablet').css("color","#000000");
                $('.fa-desktop,.fa-mobile').css("color","");
                $('#Tablette').css("color","#000000");
                $('#Originale,#Mobile').css("color","");
            }
            if(buttonName == 'mobile'){
                self.presentMobileResize();
                $('.fa-mobile').css("color","#000000");
                $('.fa-desktop,.fa-tablet').css("color","");
                $('#Mobile').css("color","#000000");
                $('#Tablette,#Originale').css("color","");
            }
            if(buttonName == 'desktop'){
                self.presentDesktopResize(); 
                $('.fa-desktop').css("color","#000000") ;
                $('.fa-tablet,.fa-mobile').css("color","");  
                $('#Originale').css("color","#000000"); 
                $('#Tablette,#Mobile').css("color","");         
            }
        ...
        // Select item before launch
        $(document).off('click', '.wcp-editor-control-button-standalone');
        $(document).on('click', '.wcp-editor-control-button-standalone', function(e) {
                var button = $(this).closest('.wcp-editor-list-item');
                var tooltip = $(this).closest('.wcp-editor-list-item-button');
                self.hideTooltip($(this));
                // $(document).off('mouseover', '[data-wcp-tooltip]');
                self.selectListItem(button.data('wcp-editor-list-item-id'));
                $.wcpEditorEventListItemSelected(button.data('wcp-editor-list-item-id'));
    ...
    WCPEditor.prototype.presentLoadModal = function() {
        ...
        $.wcpEditorGetSaves(function(savesList) {
            ...
            for (var i=0; i<savesList.length; i++) {
                ...
                modalBody += '      <div class="wcp-editor-save-list-item-delete-button"><i class="fa fa-trash" aria-hidden="true"></i></div>';
                modalBody += '  </div>';
            }
    ...
    WCPEditor.prototype.presentTabletResize = function(){
        console.log("tabet");
    }
    WCPEditor.prototype.presentDesktopResize = function(){
        console.log("desktop");
    }
    WCPEditor.prototype.presentMobileResize = function(){
        console.log("mobile");
    }
    ...
    WCPEditor.prototype.setContentForCanvas = function(content) {
        $('#wcp-editor-canvas').append(content);
    };
    WCPEditor.prototype.setListItems = function(listItems) {
        ...
        for (var i=0; i<this.options.listItemButtons.length; i++) {
            ...
            // html += '   <div class="wcp-editor-form-control" id="wcp-editor-form-control-launch_content_builder" style="display: block;">'
            // html += '       <div id="wcp-editor-control-builder-standalone"  class="wcp-editor-control-button wcp-editor-control-button-standalone">'
           
            //buttonsHTML += '<div class="wcp-editor-form-control wcp-editor-list-item-button" data-wcp-editor-list-item-button-name="'+ b.name +'" data-wcp-tooltip="'+ b.title +'" data-wcp-tooltip-position="bottom">';
            buttonsHTML += '    <div class="wcp-editor-list-item-title-button wcp-editor-control-button-standalone wcp-editor-control-button-launch" data-wcp-tooltip="Editer le contenu" data-wcp-tooltip-position="bottom">';
        ...
        if (this.options.listItemTitle && this.options.listItemTitle.length > 0) {
            ...
            if (this.options.listItemTitleButtons.length > 0) {
                ...
                //html_ += '<div id="wcp-editor-list-item-title-buttons" style="margin-bottom: 0;">';

                for (var i=0; i<this.options.listItemTitleButtons.length; i++) {
                    var b = this.options.listItemTitleButtons[i];
                    html_ += '<div class="wcp-editor-list-item-title-button '+ b.name +'" data-wcp-editor-list-item-title-button-name="'+ b.name +'" data-wcp-tooltip="'+ b.title +'" data-wcp-tooltip-position="bottom">';
                    html_ += '    <i class="'+ b.icon +'" aria-hidden="true"></i>';
                    html_ += '</div>';
                }
                //html_ += '</div>';
            }
        ...
        for (var i=0; i<listItems.length; i++) {
            ...
            html += '   <div class="wcp-editor-list-item-buttons">'+ buttonsHTML + html_ +'</div>';
            // html += '   <div class="wcp-editor-form-control" id="wcp-editor-form-control-launch_content_builder" style="display: block;">'
            // html += '       <div id="wcp-editor-control-builder-standalone"  class="wcp-editor-control-button wcp-editor-control-button-standalone">'
        ...
        // style="background-color: orange; position: absolute; left: 0; bottom: 0; height: 50px; width: 100%; overflow:hidden;line-height: 50px;font-size:16px; border-radius: 0px;"
        // html += '   <div class="wcp-editor-form-control" id="wcp-editor-form-control-launch_content_builder" style="display: block;">'
        // html += '       <div id="wcp-editor-control-builder-standalone"  class="wcp-editor-control-button wcp-editor-control-button-standalone" style="background-color: orange; position: absolute; left: 0; bottom: 0; height: 50px; width: 100%; overflow:hidden;line-height: 50px;font-size:16px; border-radius: 0px;">'
        // html += '           <i class="fa fa-pencil-square fa-lg" aria-hidden="true"></i>'
        // html += '           Éditer'
        // html += '       </div>'
        // html += '   </div>'
        // html += '</div>';
    ...
    WCPEditor.prototype.setPreviewModeOn = function() {
        ...
        $('#wcp-editor-toolbar-wrap').hide();
        $('#wcp-editor-extra-main-buttons').show();
        //hide right side
        $('#wcp-editor-right').animate({width : '0px',});
        $('#wcp-editor-right').children().hide();
        //hide left side
        $('#wcp-editor-left').animate({width : '0px',});
        $('#wcp-editor-left').children().hide();
        //hide the params
        $("#wcp-editor-title-proj").animate({height : '0px',});
    ...
    WCPEditor.prototype.setPreviewModeOff = function() {
        ...
        $('#wcp-editor-toolbar-wrap').show();
        $('#wcp-editor-extra-main-buttons').hide();
        //show left side
        $('#wcp-editor-left').show();
        $('#wcp-editor-left').animate({width : '350px',});
        $('#wcp-editor-left').children().show();
        //show right side
        $('#wcp-editor-right').show();
        $('#wcp-editor-right').animate({width : '180px',});
        $('#wcp-editor-right').children().show();
    ...
    /*-- Generate the all ControlsGroupe for WCPEDITOR --*/
    WCPEditorForm.prototype.getFormHTML = function() {
        ...
        for (var i=0; i<this.options.controlGroups.length; i++) {
            ...
            // console.log(controlGroup.groupTitle);
            // Hide controlGroup remove it if you need to show
            // Hide with event because no lauch else 'Contenu de l\'info-bulle SEE ON Image-map-Pro-editor.js at Editor.prototype.updateShapesFormState line 3474'
            // if (controlGroup.groupTitle === 'Info-bulles'
            //     || controlGroup.groupTitle === 'Paramètres de l\'info-bulle'
            //     || controlGroup.groupTitle === 'Style de souris'
            //     || controlGroup.groupTitle === 'Actions'
            //     || controlGroup.groupTitle === 'Plein écran' ){
            //     continue;
            // } else {
                ...
                tabsHTML += '   <div class="wcp-editor-form-tab-button-icon">'
                tabsHTML +=        '<i class="'+ controlGroup.groupIcon +'" aria-hidden="true"></i>'
                tabsHTML += '   </div>';
            ...
            for (var j=0; j<controlGroup.controls.length; j++) {
                ...
                // Hide some control if you need remove the render on true in image-map-pro-editor-init-jquery
                if (control.render !== false) {
                    ...
                    if ( control.name == 'choose_icon_from_library')
                        tabsContentsHTML += '<div class="wcp-editor-form-control chooseIconFromLib" id="wcp-editor-form-control-'+ control.name +'" '+ tooltipAttributes +'>';
                    else
                    ...
                    //test if its image adding
                    if(control.name == "image_src" && firstImage == ''){
                        firstImage += '<div class="wcp-editor-form-control" id="wcp-editor-form-control-'+ control.name +'" '+ tooltipAttributes +'>';
                        if (!this.controls[control.name].customLabel) {
                            firstImage += '   <label>'+ control.title;
                        }
                        firstImage += this.controls[control.name].HTML();
                        firstImage += '</label>';
                        firstImage += '</div>';
                    }
                }
    ...
    $.wcpEditorInit = function(options) {
        var defaultOptions = {
            ...
            listItemButtons: [{ name: 'Name', icon: 'fas fa-edit', title: '' }],
            newButton: true,
            previewToggle: true
        };
